    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/posts").permitAll()  // GET is public, POST requires auth
                .requestMatchers("/api/posts/{id}").permitAll()
                .requestMatchers("/api/posts/search").permitAll()
                .requestMatchers("/api/posts/tags/{tag}").permitAll()
                .requestMatchers("/api/users/{id}/posts").permitAll()
